...
vim.api.nvim_create_autocmd("Filetype", {
	...
	callback = function()
		...
		set("n", "<C-Space>", "<Plug>(neorg.qol.todo-items.todo.task-cycle)", "Neorg cycle task")
		set("n", "<leader>mi", "<Plug>(neorg.qol.todo-items.todo.task-important)", "Neorg set important")
		set("n", "<leader>mp", "<Plug>(neorg.qol.todo-items.todo.task-pending)", "Neorg set pending")
		set("n", "<leader>mn", "<Plug>(neorg.dirman.new-note)", "Neorg new note")
		set("n", "<leader>md", "<Plug>(neorg.insert-date)", "Neorg insert date")
		set("n", "<leader>mc", "<Plug>(neorg.looking-glass.magnify-code-block)", "Neorg magnify code block")
