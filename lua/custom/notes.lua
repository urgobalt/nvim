...
local function client_cb(client)
	vim.keymap.set("n", "<leader>mo", "<CMD>ObsidianOpen<CR>", { desc = "Open current buffer in Obsidian" })

	vim.keymap.set("n", "<leader>mn", "<CMD>ObsidianNew<CR>", { desc = "Create a new Obsidian note" })
	vim.keymap.set(
		"v",
		"<leader>mn",
	...
	vim.keymap.set("n", "<leader>mr", "<CMD>ObsidianRename<CR>", { desc = "Rename current Obsidian note" })
	vim.keymap.set(
		"v",
		"<leader>me",
	...
	vim.keymap.set({ "n", "v" }, "<leader>ml", "<CMD>ObsidianLink<CR>", { desc = "Link to note" })
	vim.keymap.set(
		"n",
		"<leader>mt",
		"<CMD>ObsidianTags<CR>",
	...
	vim.keymap.set("n", "<leader>mb", "<CMD>ObsidianBacklinks<CR>", { desc = "Open list of backlinks in current note" })
	vim.keymap.set("n", "<leader>m/", "<CMD>ObsidianTOC<CR>", { desc = "Open table of contents in current picker" })
	vim.keymap.set("n", "<leader>mq", "<CMD>ObsidianToggleCheckbox<CR>", { desc = "Cycle through checkbox states" })
...
require("render-markdown").setup({
	...
	checkbox = {
		custom = {
			...
			arrow = { raw = "[>]", rendered = " ", highlight = "RenderMarkdownHint" },
			tilde = { raw = "[~]", rendered = "󰰱 ", highlight = "RenderMarkdownError" },
